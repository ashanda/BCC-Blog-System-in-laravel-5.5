                                ...
                                <nav class="mainmenu_wrapper">
                                    <ul class="mainmenu nav sf-menu">
                                        ...
                                        <li class="@yield('class5')">
                                            <a href="/Old_Boys_Association">BCC OLD Boys Association</a>
                                            
                                        <!-- eof pages -->

                                        <li class="@yield('class6')">
                                            <a href="/colombo_chapter">BCC colombo chapter</a>
                                ...
                                <div class="col-md-6">
                                    <div class="with_padding text-center ds bg_teaser after_cover darkblue_bg">
                                        ...
                                        <div>
                                            ...
                                            <h4 class="semibold">
                                                <a href="./blog-single-left.html" rel="bookmark">Pork chop biltong pork loin strip steak</a>
                                            </h4>
                                        </div>
                                        <!-- eof .item-content -->
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="with_padding text-center ds bg_teaser after_cover darkblue_bg">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h4 class="semibold">
                                                <a href="./blog-single-left.html" rel="bookmark">Shoulder drumstick apico short loin</a>
                                            </h4>
                                        </div>
                                        <!-- eof .item-content -->
                                    </div>
